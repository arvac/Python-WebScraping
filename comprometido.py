...
workbook = openpyxl.load_workbook(r'C:\xampp\htdocs\py\16_6_2023\comprometidos_16_06_2023_vacio.xlsx')
...
'''
        try:
           ...
           #a_element = driver.find_element(By.CSS_SELECTOR, 'a img.systemImage[alt="sigma"]')
           driver.find_element(By.ID,"//table[@id='jdeGridData0_1.0']//td[contains(text(), '560')]")
      ...
      # Si el primer elemento no está presente, hacer clic en el segundo elemento
           #a_element = driver.find_element(By.CSS_SELECTOR, 'a img.systemImage[alt="Sin anexos"]')
           #driver.find_element(By.ID,"//table[@id='jdeGridData0_1.0']//td[contains(text(), '620')]")
       #a_element.click()
           driver.find_element(By.NAME, "hc_Close").click()
           driver.switch_to.default_content()
           time.sleep(2)
