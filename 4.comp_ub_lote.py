...
def proceso():
 workbook = openpyxl.load_workbook(r'C:\xampp\htdocs\py\comp\lleno.xlsx')
...
#select.select_by_value("9f590f83eeb0495a9c664ccf672f7411")
        ...
        driver.find_element(By.NAME, "qbe0_1.2").send_keys("!=S")
    ...
    #para campo vació y completos
          ...
          driver.find_element(By.ID, "PO7T0").send_keys("B")
          driver.find_element(By.ID, "hc_Select").click()
